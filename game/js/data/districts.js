...
export const DISTRICTS = [
  // ---------------- Manhattan ----------------
  { id: 'wash-heights',  name: "Washington Heights",         borough: 'manhattan', rect: { x0: 19, x1: 28, y0: 6,  y1: 13 }, startPopK: 140, character: 'rowhouse' },
  { id: 'harlem',        name: "Harlem & East Harlem",       borough: 'manhattan', rect: { x0: 23, x1: 28, y0: 6,  y1: 13 }, startPopK: 260, character: 'dense-tenement' },
  { id: 'morningside',   name: "Morningside Heights",        borough: 'manhattan', rect: { x0: 19, x1: 23, y0: 13, y1: 20 }, startPopK: 90,  character: 'rowhouse' },
  { id: 'yorkville',     name: "Yorkville & Carnegie Hill",  borough: 'manhattan', rect: { x0: 23, x1: 28, y0: 13, y1: 20 }, startPopK: 220, character: 'dense-tenement' },
  ...
  { id: 'village-soho',  name: "Greenwich Village & SoHo",   borough: 'manhattan', rect: { x0: 19, x1: 28, y0: 34, y1: 39 }, startPopK: 280, character: 'dense-tenement' },
  { id: 'les-financial', name: "Lower East Side & Financial",borough: 'manhattan', rect: { x0: 19, x1: 28, y0: 39, y1: 44 }, startPopK: 350, character: 'dense-tenement' },
  ...
  { id: 'pelham-bay',  name: "Pelham Bay & Throgs Neck",   borough: 'bronx', rect: { x0: 38, x1: 42, y0: 0, y1: 4 }, startPopK: 92,  character: 'suburban' },
  ...
  { id: 'flushing',       name: "Flushing",                    borough: 'queens', rect: { x0: 49, x1: 58, y0: 6,  y1: 14 }, startPopK: 45,  character: 'suburban' },
  ...
  { id: 'rockaway',       name: "Rockaway Peninsula",          borough: 'queens', rect: { x0: 45, x1: 58, y0: 22, y1: 30 }, startPopK: 69,  character: 'suburban' },
  ...
  { id: 'flatbush',           name: "Flatbush & Flatlands",          borough: 'brooklyn', rect: { x0: 44, x1: 51, y0: 42, y1: 54 }, startPopK: 210, character: 'rowhouse' },
  { id: 'coney-island',       name: "Coney Island & Brighton Beach", borough: 'brooklyn', rect: { x0: 51, x1: 58, y0: 42, y1: 54 }, startPopK: 138, character: 'suburban' },

  // ---------------- Staten Island ----------------
  { id: 'st-george',  name: "St. George & North Shore",  borough: 'staten-island', rect: { x0: 8, x1: 24, y0: 40, y1: 46 }, startPopK: 55, character: 'rowhouse' },
  { id: 'todt-hill',  name: "Todt Hill & Mid-Island",    borough: 'staten-island', rect: { x0: 8, x1: 24, y0: 46, y1: 51 }, startPopK: 32, character: 'suburban' },
  { id: 'tottenville',name: "Tottenville & South Shore", borough: 'staten-island', rect: { x0: 8, x1: 24, y0: 51, y1: 56 }, startPopK: 30, character: 'rural' },
  ...
  // ---------------- New Jersey ----------------
  { id: 'hoboken',     name: "Hoboken",     borough: 'new-jersey', rect: { x0: 10, x1: 16, y0: 10, y1: 18 }, startPopK: 70,  character: 'dense-tenement' },
  { id: 'jersey-city', name: "Jersey City", borough: 'new-jersey', rect: { x0: 8,  x1: 16, y0: 18, y1: 30 }, startPopK: 298, character: 'industrial-core' },
  { id: 'bayonne',     name: "Bayonne",     borough: 'new-jersey', rect: { x0: 8,  x1: 16, y0: 30, y1: 38 }, startPopK: 76,  character: 'industrial-core' },
  { id: 'newark',      name: "Newark",      borough: 'new-jersey', rect: { x0: 0,  x1: 8,  y0: 14, y1: 38 }, startPopK: 414, character: 'industrial-core' },
];
